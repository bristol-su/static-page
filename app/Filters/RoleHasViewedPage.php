...
class RoleHasViewedPage extends RoleFilter
{
    ...
    public function moduleInstances()
    {
        return app(ModuleInstanceRepository::class)->allWithAlias('static-page')->filter(function(ModuleInstance $moduleInstance) {
            return $moduleInstance->activity->activity_for === 'role';
    ...
    public function evaluate($settings): bool
    {
        ...
        $activityInstance = app(DefaultActivityInstanceGenerator::class)->generate($moduleInstance->activity, 'role', $this->role()->id());
    ...
    {
        return 'Static Page: Role has viewed page';
    }
    ...
    {
        return 'A role has viewed a given static page module.';
    }
    ...
    {
        return 'static_page_role_has_viewed_page';
    }
}